	...
	*-------------------------------------------------------------------------------------------------------------------------*
	   ...
	   * ---------------------
	   ...
	   if $user == 3 {
		   global projectfolder 	"C:\Users\wb495845\OneDrive - WBG\I. Education\financial-education-brazil"
		   global dofiles    		"C:\Users\wb495845\OneDrive - WBG\Documents\GitHub\financial-education-brazil\Do files" //GITHUB
	   }
	...
	*-------------------------------------------------------------------------------------------------------------------------*
	 //Tables 4, B8, B9 and B14-> Code run in INEP facilities in Brazil as we need confidential information so our public do files do not reproduce these tables.
