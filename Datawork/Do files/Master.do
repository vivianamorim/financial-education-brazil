	...
	*-------------------------------------------------------------------------------------------------------------------------*
	   ...
	   * ---------------------
	   ...
	   if $user == 3 {
		   global projectfolder		"C:\Users\vivia\OneDrive\Documentos\GitHub\financial-education-brazil\"
		   global dofiles    		"C:\Users\vivia\OneDrive\Documentos\GitHub\financial-education-brazil\Datawork\Do files"
	   }
	   ...
	   if $user == 4 {
		...
		global identified			 "$data/0. DeIdentification/Identified"			//identified microdata (not in the public package)
		global tables 				 "$projectfolder/DataWork/Output/Tables"
		global descriptives			 "$tables"										//no subfolders: every table sits in Output/Tables
		global results			     "$tables/Results"
		global figures 				 "$projectfolder/DataWork/Output/Figures"
		global textables			 "$tables"										//LaTeX table fragments \input by the paper (DataWork/Output/Tables)
