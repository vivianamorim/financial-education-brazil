*ARCHIVED 2026-08-19 -- legacy tail of 3_Descriptives.do, moved here unchanged.
*Everything below was already commented out in the live file: legacy Excel exports whose
*numbering predates the current paper, exploratory blocks, the IDEB-vs-proficiency scatter
*plots, and the superseded first writer of the implementation table.
